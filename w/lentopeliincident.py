...
bums = [
    ...
    "beggars ",
    "esteemed companions ",
    "exquisite street dwellers ",
    "street connoisseurs ",
    "great financial decision makers ",
    "untamed wanderers ",
    "rogue individuals ",
    "wild bums "
]
...
random_eri_ending = random.choice(eri_ending)
...
random_eri_ender = random.choice(eri_ender)

pummit_loppu = [
    f"This area contains no more {bum}, {random_eri_ending}{random_eri_ender}",
    f"This location contains no more {bum}, {random_eri_ending}{random_eri_ender}",
    f"This place contains no more {bum}, {random_eri_ending}{random_eri_ender}",

    f"There are no more {bum}in this area, {random_eri_ending}{random_eri_ender}",
    f"There are no more {bum}in this location, {random_eri_ending}{random_eri_ender}",
    f"There are no more {bum}in this place, {random_eri_ending}{random_eri_ender}",

    f"You see no more {bum}in this location, {random_eri_ending}{random_eri_ender}",
    f"You see no more {bum}in this place, {random_eri_ending}{random_eri_ender}",
    f"You see no more {bum}in here, {random_eri_ending}{random_eri_ender}"

]
print_pummit_loppu = random.choice(pummit_loppu)

print(print_pummit_loppu)
